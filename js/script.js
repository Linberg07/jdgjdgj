...
$(document).ready(function(){
	...
	$('.popup-sliderText').on('afterChange', function(event, slick, currentSlide, nextSlide){
	$(this).parent().find('.sliderText-dots__item').each(function(){
  	$(this).removeClass('active');
  	if($(this).data('index')-1 == currentSlide){
  ...
  $this.addClass('active');
  $('.popup-sliderText').slick('slickGoTo', $this.data('index')-1)
});
	...
	$('#item1').click(function(){
		...
		$(".popup-sliderText").slick('setPosition');
	})
